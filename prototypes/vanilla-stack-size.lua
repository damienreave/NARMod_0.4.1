...
data.raw["item"]["science-pack-1"].stack_size = 20
data.raw["item"]["science-pack-2"].stack_size = 20
data.raw["item"]["science-pack-3"].stack_size = 20
...
data.raw["item"]["rocket-defense"].stack_size = 1
