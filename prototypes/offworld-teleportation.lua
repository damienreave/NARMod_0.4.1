 data:extend(
{
 
 {
    ...
    icon = "__NARMod__/graphics/icons/offworld-teleportation/offworld-teleportation.png",
    effects =
    {
      {
        type = "unlock-recipe",
  ...
  
  {
    ...
    icon = "__NARMod__/graphics/icons/offworld-teleportation/military-supply-contract.png",
    effects =
    {
      {
        type = "unlock-recipe",
  ...
  
  {
    ...
    icon = "__NARMod__/graphics/icons/offworld-teleportation/electronics-supply-contract.png",
    effects =
    {
      {
        type = "unlock-recipe",
 ...
 -- OFFWORLD TELEPORTER
    ...
    icon = "__NARMod__/graphics/icons/offworld-teleportation/offworld-teleporter.png",
    ...
    animation =
    {
      filename = "__NARMod__/graphics/icons/offworld-teleportation/offworld-teleporter/offworld-teleporter.png",
      priority = "high",
      width = 142,
      height = 113,
      frame_count = 1,
  ...
  
  {
    type = "item",
    name = "tank-platoon",
    icon = "__NARMod__/graphics/icons/offworld-teleportation/tank-platoon.png",
  ...
  
  {
    ...
    icon = "__NARMod__/graphics/icons/offworld-teleportation/rifle-platoon.png",
    flags = {"goes-to-main-inventory"},
    subgroup = "military-vp",
    order = "a",
    stack_size = 5
  ...
  
  {
    ...
    icon = "__NARMod__/graphics/icons/offworld-teleportation/rifle-platoon-ammo.png",
    flags = {"goes-to-main-inventory"},
    subgroup = "military-vp",
    order = "b",
    stack_size = 5
  ...
  
  {
    type = "item",
    name = "military-vp",
    icon = "__NARMod__/graphics/icons/offworld-teleportation/military-vp.png",
    flags = {"goes-to-main-inventory"},
    subgroup = "military-vp",
    order = "d",
    stack_size = 1000
  ...
  
  {
    ...
    icon = "__NARMod__/graphics/icons/offworld-teleportation/cellphones-package.png",
    flags = {"goes-to-main-inventory"},
  ...
  
  {
    ...
    icon = "__NARMod__/graphics/icons/offworld-teleportation/tablets-package.png",
    flags = {"goes-to-main-inventory"},
    subgroup = "electronics-vp",
  ...
  
  {
    type = "item",
    name = "pcs-package",
    icon = "__NARMod__/graphics/icons/offworld-teleportation/pcs-package.png",
    flags = {"goes-to-main-inventory"},
    subgroup = "electronics-vp",
    order = "a[tablets-package]",
    stack_size = 150
  ...
  
  {
    type = "item",
    name = "electronics-vp",
    icon = "__NARMod__/graphics/icons/offworld-teleportation/electronics-vp.png",
    flags = {"goes-to-main-inventory"},
    subgroup = "electronics-vp",
    order = "d",
    stack_size = 1000
